...
<div>
  <div id="top" class="bg-primary-500">
    <nav
    ...
    >
      <div class="flex items-center justify-between">
        <a
          ...
          href="{base}/"
          ><img alt="The project logo" src={logo} class="h-20" />
        </a>
        <!-- Mobile menu button -->
      ...
      <div
        class="flex-col font-Akaya text-2xl mt-8 space-y-4 md:flex md:space-y-0 md:flex-row md:items-center md:space-x-10 md:mt-0 {showMenu
          ? 'flex'
          : 'hidden'}"
      >
